...
* create the virtual environment (in bash, move the the repository folder and run `bash ./create_socdiv_venv.sh`)
* in the jupyter notebooks, always check that you are connected to the *socdiv_venv* kernel
* if you need to install any additional packages within the virtual environment, you need to activate the environemt in bash `source  socdiv_venv/bin/activate`
